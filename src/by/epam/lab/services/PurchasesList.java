...
import by.epam.lab.beans.PrintPurchase;
    ...
    public PurchasesList(String fileName) {
        ...
        try {
            ...
            while (scanner.hasNext()) {
                ...
                } catch (CsvLineException e) {System.err.println(e);
                }
                if (purchase != null) { purchases.add(purchase);
                }}

        } catch (FileNotFoundException e) {
            System.err.println(Constants.ERROR_FILE + Constants.PACKAGE+ fileName + Constants.VALUE_FORMAT);
        } }
